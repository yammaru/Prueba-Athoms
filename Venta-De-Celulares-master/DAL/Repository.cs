...
namespace DAL
{
    public abstract class Repository<T> where T : new()
    {
        ...
        protected readonly string connectionString = $"Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=VentaDeCelulares;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
